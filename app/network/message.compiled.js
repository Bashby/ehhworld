...
export const protobuf = $root.protobuf = (() => {
  ...
  protobuf.Message = (function() {
    ...
    Message.encode = function encode(message, writer) {
      ...
      if (message.move != null && message.hasOwnProperty("move")) { $root.protobuf.Move.encode(message.move, writer.uint32(/* id 10, wireType 2 = */82).fork()).ldelim(); }
      if (message.attack != null && message.hasOwnProperty("attack")) { $root.protobuf.Attack.encode(message.attack, writer.uint32(/* id 11, wireType 2 = */90).fork()).ldelim(); }
      if (message.build != null && message.hasOwnProperty("build")) { $root.protobuf.Build.encode(message.build, writer.uint32(/* id 12, wireType 2 = */98).fork()).ldelim(); }
      if (message.sleep != null && message.hasOwnProperty("sleep")) { $root.protobuf.Sleep.encode(message.sleep, writer.uint32(/* id 13, wireType 2 = */106).fork()).ldelim(); }
      return writer;
    };
    ...
    Message.decode = function decode(reader, length) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.protobuf.Message();
    ...
    Message.verify = function verify(message) {
      ...
      if (message.move != null && message.hasOwnProperty("move")) {
        ...
        {
          const error = $root.protobuf.Move.verify(message.move);
          if (error) { return `move.${error}`; }
        }
      }
      if (message.attack != null && message.hasOwnProperty("attack")) {
        ...
        properties.payload = 1;
        {
          const error = $root.protobuf.Attack.verify(message.attack);
          if (error) { return `attack.${error}`; }
        }
      }
      if (message.build != null && message.hasOwnProperty("build")) {
        ...
        properties.payload = 1;
        {
          const error = $root.protobuf.Build.verify(message.build);
      ...
      if (message.sleep != null && message.hasOwnProperty("sleep")) {
        ...
        properties.payload = 1;
        {
          const error = $root.protobuf.Sleep.verify(message.sleep);
          if (error) { return `sleep.${error}`; }
        }
      }
      return null;
    };
    ...
    Message.fromObject = function fromObject(object) {
      if (object instanceof $root.protobuf.Message) { return object; }
      const message = new $root.protobuf.Message();
      if (object.move != null) {
        if (typeof object.move !== "object") { throw TypeError(".protobuf.Message.move: object expected"); }
        message.move = $root.protobuf.Move.fromObject(object.move);
      }
      if (object.attack != null) {
        if (typeof object.attack !== "object") { throw TypeError(".protobuf.Message.attack: object expected"); }
        message.attack = $root.protobuf.Attack.fromObject(object.attack);
      }
      if (object.build != null) {
        if (typeof object.build !== "object") { throw TypeError(".protobuf.Message.build: object expected"); }
        message.build = $root.protobuf.Build.fromObject(object.build);
      }
      if (object.sleep != null) {
        if (typeof object.sleep !== "object") { throw TypeError(".protobuf.Message.sleep: object expected"); }
  ...
  protobuf.Move = (function() {
    ...
    Move.encode = function encode(message, writer) {
      if (!writer) { writer = $Writer.create(); }
      if (message.direction != null && message.hasOwnProperty("direction")) { writer.uint32(/* id 1, wireType 2 = */10).string(message.direction); }
      return writer;
    };
    ...
    Move.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader); }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.protobuf.Move();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Move.verify = function verify(message) {
      ...
      if (message.direction != null && message.hasOwnProperty("direction")) {
        if (!$util.isString(message.direction)) { return "direction: string expected"; }
      }
      return null;
    };
    ...
    Move.fromObject = function fromObject(object) {
      if (object instanceof $root.protobuf.Move) { return object; }
      const message = new $root.protobuf.Move();
      if (object.direction != null) { message.direction = String(object.direction); }
      return message;
    };
    ...
    Move.toObject = function toObject(message, options) {
      if (!options) { options = {}; }
      const object = {};
      if (options.defaults) { object.direction = ""; }
  ...
  protobuf.Attack = (function() {
    ...
    Attack.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader); }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.protobuf.Attack();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Attack.fromObject = function fromObject(object) {
      if (object instanceof $root.protobuf.Attack) { return object; }
      const message = new $root.protobuf.Attack();
  ...
  protobuf.Build = (function() {
    ...
    Build.encode = function encode(message, writer) {
      if (!writer) { writer = $Writer.create(); }
      if (message.type != null && message.hasOwnProperty("type")) { writer.uint32(/* id 1, wireType 2 = */10).string(message.type); }
      return writer;
    };
    ...
    Build.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader); }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.protobuf.Build();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Build.fromObject = function fromObject(object) {
      if (object instanceof $root.protobuf.Build) { return object; }
      const message = new $root.protobuf.Build();
  ...
  protobuf.Sleep = (function() {
    ...
    Sleep.encode = function encode(message, writer) {
      if (!writer) { writer = $Writer.create(); }
      if (message.duration != null && message.hasOwnProperty("duration")) { writer.uint32(/* id 1, wireType 2 = */10).string(message.duration); }
      return writer;
    };
    ...
    Sleep.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader); }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.protobuf.Sleep();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Sleep.verify = function verify(message) {
      ...
      if (message.duration != null && message.hasOwnProperty("duration")) {
        if (!$util.isString(message.duration)) { return "duration: string expected"; }
      }
      return null;
    };
    ...
    Sleep.fromObject = function fromObject(object) {
      if (object instanceof $root.protobuf.Sleep) { return object; }
      const message = new $root.protobuf.Sleep();
      if (object.duration != null) { message.duration = String(object.duration); }
      return message;
    };
    ...
    Sleep.toObject = function toObject(message, options) {
      if (!options) { options = {}; }
      const object = {};
      if (options.defaults) { object.duration = ""; }
